    ...
    return Drawer(
      child: ListView(
        children: <Widget>[
          GestureDetector(
            onTap: () {
              Navigator.of(context).pushNamed('/RestaurantPages', arguments: 2);
            },
          ...
          ListTile(
            onTap: () {
              Navigator.of(context).pushNamed('/RestaurantPages', arguments: 0);
            },
            leading: Icon(
              Icons.fastfood,
          ...
          ListTile(
            onTap: () {
              Navigator.of(context).pushNamed('/addfooditem');
            },
            leading: Icon(
              Icons.add,
              color: Theme.of(context).focusColor.withOpacity(1),
